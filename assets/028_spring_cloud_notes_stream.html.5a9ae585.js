import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as l,a as e,d as a,b as d,e as r,r as t}from"./app.cf73cc21.js";const u={},v=r(`<blockquote><p>Spring Cloud Stream 是 Spring Cloud 体系中的消息中间件组件，它集成了 kafka 和 rabbitMQ</p><p>它屏蔽掉了底层不同消息中间件之间的差异，降低了学习成本和维护成本 (就像我们用 ORM 框架来取代直接操作数据库一样)</p></blockquote><h2 id="快速上手" tabindex="-1"><a class="header-anchor" href="#快速上手" aria-hidden="true">#</a> 快速上手</h2><p>编写代码之前我们需要搭建一个 rabbitMQ 环境，这里不再累述</p><h3 id="构建消息生产者-stream-producer" tabindex="-1"><a class="header-anchor" href="#构建消息生产者-stream-producer" aria-hidden="true">#</a> 构建消息生产者 stream-producer</h3><ol><li>引入依赖</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>消费者这边我们可以看到控制台成功打印消息 <img src="https://i.loli.net/2021/01/18/m4ziAH8wjDrLn3p.png" alt="m4ziAH8wjDrLn3p" loading="lazy"></p><h2 id="高级部分" tabindex="-1"><a class="header-anchor" href="#高级部分" aria-hidden="true">#</a> 高级部分</h2><p>现在我们对 stream-consumer 的配置文件进行修改</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>server:
  port: 10012
spring:
  application:
    name: stream-consumer
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4"><li><p>重启项目，并打开 rabbitmq 的可视化界面</p><ul><li>发布一条消息 <img src="https://i.loli.net/2021/01/18/qei2asorGvERSM1.png" alt="qei2asorGvERSM1" loading="lazy"></li><li>结果如下 <img src="https://i.loli.net/2021/01/18/1AG7PzVvjs3lhIe.png" alt="1AG7PzVvjs3lhIe" loading="lazy"></li></ul></li></ol><h3 id="消息分组" tabindex="-1"><a class="header-anchor" href="#消息分组" aria-hidden="true">#</a> 消息分组</h3><p>在微服务体系下，我们的服务有可能不是一个实例，但是对于消息我们只需要消费一次，而不是让所有的实例都消费。</p><p>Spring Cloud Stream 的解决方案是设置 group， 只要把这些实例的 group 设为同一个，那就只有一个实例消费消息，避免重复消费。这是因为如果设置了 group，那么 exchange 流向的 queue 名称就会成为 group 的名称，否则就是随机字符串</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  cloud:
    stream:
      bindings:
        input:
          destination: stream.message
    ...
    stream:
      bindings:
        ...
        log_output:
          destination: stream.log_message
          binder: remote_rabbit
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>配置完成，重启项目试试看吧</p><h3 id="其他" tabindex="-1"><a class="header-anchor" href="#其他" aria-hidden="true">#</a> 其他</h3><p>Spring Cloud Stream 中还有消费分区、消息降级等概念，篇幅有限，就不做展开啦(<em><sup>▽</sup></em>)</p><h2 id="相关源码地址" tabindex="-1"><a class="header-anchor" href="#相关源码地址" aria-hidden="true">#</a> 相关源码地址</h2><p>仅供参考</p>`,69),c={href:"https://github.com/logycoconut/Spring-Cloud-Notes/tree/master/stream",target:"_blank",rel:"noopener noreferrer"};function m(o,b){const i=t("ExternalLinkIcon");return s(),l("div",null,[v,e("p",null,[e("a",c,[a("https://github.com/logycoconut/Spring-Cloud-Notes/tree/master/stream"),d(i)])])])}const h=n(u,[["render",m],["__file","028_spring_cloud_notes_stream.html.vue"]]);export{h as default};
