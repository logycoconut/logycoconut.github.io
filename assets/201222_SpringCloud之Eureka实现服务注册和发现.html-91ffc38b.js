import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as p,c,a as n,b as a,d as e,f as i}from"./app-d50118f0.js";const r={},o=i(`<blockquote><p>如果我们要去租房，我们可能首先要去找中介，中介手上有很多房源，我们能在中介这里找到自己需要的房源</p><p>而微服务体系中，也存在这么一个中介，就是服务注册与发现中心，它为服务的提供者和服务的消费者提供一个交流的平台，Provider可以在注册中心注册供其他服务使用，Consumer可以在注册中心中寻找自己需要的服务</p><p>Eureka 是 Netflix 开发的服务发现组件，Spring Cloud 将它集成在其子项目spring-cloud-netflix中，以实现 Spring Cloud 的服务发现功能</p></blockquote><h2 id="简单实现" tabindex="-1"><a class="header-anchor" href="#简单实现" aria-hidden="true">#</a> 简单实现</h2><h3 id="版本说明和依赖" tabindex="-1"><a class="header-anchor" href="#版本说明和依赖" aria-hidden="true">#</a> 版本说明和依赖</h3><ul><li>Java: 1.8</li><li>Spring Boot: 2.3.2.RELEASE</li><li>Spring Cloud: Hoxton.SR8</li></ul><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependencyManagement</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4"><li><p>请求consume方法可以看到成功返回数据</p></li><li><p>我们可以provider服务的方法中加入打印日志，并同时启动两个provider服务，查看控制台信息，验证负载均衡功能</p></li></ol><figure><img src="https://i.loli.net/2020/12/24/GXPeplQ4VS79CTW.png" alt="GXPeplQ4VS79CTW" tabindex="0" loading="lazy"><figcaption>GXPeplQ4VS79CTW</figcaption></figure><figure><img src="https://i.loli.net/2020/12/24/oDFIB4sjkuTezyL.png" alt="oDFIB4sjkuTezyL" tabindex="0" loading="lazy"><figcaption>oDFIB4sjkuTezyL</figcaption></figure><h2 id="eureka实现高可用" tabindex="-1"><a class="header-anchor" href="#eureka实现高可用" aria-hidden="true">#</a> Eureka实现高可用</h2><p>实现高可用的关建就是运行多台Eureka服务器并让他们相互注册，并让其他服务都注册到这些注册中心</p><h3 id="修改注册中心配置" tabindex="-1"><a class="header-anchor" href="#修改注册中心配置" aria-hidden="true">#</a> 修改注册中心配置</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>spring:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在idea的Services栏中复制一份注册中心的启动配置</p><figure><img src="https://i.loli.net/2020/12/25/6xjV4yhogvaYmHL.png" alt="微信截图_20201225113543.png" tabindex="0" loading="lazy"><figcaption>微信截图_20201225113543.png</figcaption></figure><p>修改profiles参数</p><figure><img src="https://i.loli.net/2020/12/25/qZGuwPynCVR1mbM.png" alt="微信截图_20201225113610.png" tabindex="0" loading="lazy"><figcaption>微信截图_20201225113610.png</figcaption></figure><h3 id="修改服务提供者和消费者的配置" tabindex="-1"><a class="header-anchor" href="#修改服务提供者和消费者的配置" aria-hidden="true">#</a> 修改服务提供者和消费者的配置</h3><p>就是在client服务中添加所有的server地址, 但是要注意的是client1配置server1, server2，client2配置server2, server1</p><p>client会优先从第一个开始找，找到能连通的就从那里同步数据，找不到会继续找一直到最后。如果前面的server挂掉了，就找后面的server， 这样才能达到高可用的目的</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>eureka:
  client:
    service-url:
      defaultZone: http://localhost:10010/eureka, http://localhost:10009/eureka
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="相关源码地址" tabindex="-1"><a class="header-anchor" href="#相关源码地址" aria-hidden="true">#</a> 相关源码地址</h2><p>仅供参考</p>`,25),h={href:"https://github.com/logycoconut/Spring-Cloud-Notes/tree/master/eureka",target:"_blank",rel:"noopener noreferrer"};function y(f,_){const s=l("ExternalLinkIcon");return p(),c("div",null,[o,n("ol",u,[n("li",null,[a("运行 Application.java 文件，并访问 "),n("a",d,[a("http://localhost:10010"),e(s)]),a(" （没有任何后缀）")])]),v,n("ol",k,[n("li",null,[n("p",null,[a("运行 Application.java 文件，并查看 "),n("a",m,[a("http://localhost:10010"),e(s)]),a(" 是否有提供商的注册信息")])]),g]),b,n("p",null,[n("a",h,[a("https://github.com/logycoconut/Spring-Cloud-Notes/tree/master/eureka"),e(s)])])])}const E=t(r,[["render",y],["__file","201222_SpringCloud之Eureka实现服务注册和发现.html.vue"]]);export{E as default};
