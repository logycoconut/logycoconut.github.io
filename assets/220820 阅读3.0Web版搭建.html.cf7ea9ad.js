import{_ as s}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as a,c as d,a as e,b as n,d as r,e as l,r as c}from"./app.b286dc60.js";const v={},t=l(`<h3 id="使用说明" tabindex="-1"><a class="header-anchor" href="#使用说明" aria-hidden="true">#</a> 使用说明</h3><blockquote><p>文档比我说的明白....</p><ol><li>在自己的服务器上部署（推荐docker）</li><li>在iOS上使用Safari访问并添加到桌面</li></ol></blockquote><h3 id="配置文件" tabindex="-1"><a class="header-anchor" href="#配置文件" aria-hidden="true">#</a> 配置文件</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>version: &#39;3.1&#39;
services:
# reader 在线阅读
