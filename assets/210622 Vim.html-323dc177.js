import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as a,o as s,c as l,a as e,b as i,d as r,f as v,e as c}from"./app-c617e56e.js";const u={},t=v(`<h3 id="基本模式" tabindex="-1"><a class="header-anchor" href="#基本模式" aria-hidden="true">#</a> 基本模式</h3><ul><li>Normal：用于光标移动、搜索替换、复制粘贴删除</li><li>Visual：用于选中、反选（v: 按字符选中 V：按行选中）</li><li>Command： 用于文档操作，例如读取、保存</li><li>Insert：用于编辑内容</li></ul><h3 id="光标移动" tabindex="-1"><a class="header-anchor" href="#光标移动" aria-hidden="true">#</a> 光标移动</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>^: 移到行首
$: 移到行尾
