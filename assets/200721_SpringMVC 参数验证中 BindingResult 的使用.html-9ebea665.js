import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as n,f as a}from"./app-d082d9eb.js";const r={},d=a(`<blockquote><p>在不需要统一处理异常时使用</p></blockquote><h2 id="代码示例" tabindex="-1"><a class="header-anchor" href="#代码示例" aria-hidden="true">#</a> 代码示例</h2><h3 id="创建实体类" tabindex="-1"><a class="header-anchor" href="#创建实体类" aria-hidden="true">#</a> 创建实体类</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@Data
public class User {
