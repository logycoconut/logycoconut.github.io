import{_ as n,Y as s,Z as a,a2 as e}from"./framework-beff9ad1.js";const t={},i=e(`<blockquote><p>我们在实际开发中，对表中记录经常需要记录是谁创建的、谁最后修改过、修改时间是什么时候。 Auditing意为审计，是Jpa为我们提供的以上功能实现</p></blockquote><h2 id="基本实现" tabindex="-1"><a class="header-anchor" href="#基本实现" aria-hidden="true">#</a> 基本实现</h2><h3 id="四个注解" tabindex="-1"><a class="header-anchor" href="#四个注解" aria-hidden="true">#</a> 四个注解</h3><ul><li><code>@CreatedDate</code></li><li><code>@LastModifiedDate</code></li><li><code>@CreatedBy</code></li><li><code>@LastModifiedBy</code></li></ul><h3 id="代码示例" tabindex="-1"><a class="header-anchor" href="#代码示例" aria-hidden="true">#</a> 代码示例</h3><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">// 实体类</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,17),p=[i];function c(o,l){return s(),a("div",null,p)}const u=n(t,[["render",c],["__file","020_springdatajpa_auditing.html.vue"]]);export{u as default};
