import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as s,o as r,c as t,a as e,b as i,d,f as l}from"./app-dfc4fa93.js";const c={},v=l(`<blockquote><p>对于一些简单的应用，我们一般都是直接把配置信息写在 application.yml 中，复杂点的就分成dev、prod之类，但是这样做有两个缺点，一是当我们修改了配置之后，必须要重启服务才能使服务生效，二则是随着应用和配置信息的增多，我们很容易在修改配置信息的过程中混乱</p><p>为了实现对配置文件的实时更新和统一管理，我们需要一个配置中心，用来存放和发放配置信息</p></blockquote><h2 id="构建配置中心-从本地读取配置" tabindex="-1"><a class="header-anchor" href="#构建配置中心-从本地读取配置" aria-hidden="true">#</a> 构建配置中心，从本地读取配置</h2><p>1、新建一个 SpringBoot 项目，并导入依赖</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
