import{_ as e}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as n,c as i,e as t}from"./app.10c1064b.js";const l={},s=t(`<blockquote><p>忘记的时候翻一翻</p></blockquote><h2 id="基本注解" tabindex="-1"><a class="header-anchor" href="#基本注解" aria-hidden="true">#</a> <strong>基本注解</strong></h2><p><code>@Controller</code> 定义一个Controller控制器</p><p><code>@RequestMapping</code> 映射URL到控制器类</p><p><code>@RequestParam</code>、<code>@RequestBody</code> 获取请求体参数</p><p><code>@RequestHeader</code> 获取请求头</p><p><code>@PathVariable</code> 获取URL里的变量</p><p><code>@ModelAttribute</code> 在Controller的方法执行之前执行</p><p><code>@CookieValue</code>、<code>@SessionAttribute</code> 获取Cookie、Session的参数</p><h2 id="web-xml文件示例" tabindex="-1"><a class="header-anchor" href="#web-xml文件示例" aria-hidden="true">#</a> <strong>web.xml文件示例</strong></h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!DOCTYPE web-app PUBLIC
...
&lt;/form&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,24),r=[s];function a(d,v){return n(),i("div",null,r)}const u=e(l,[["render",a],["__file","005_spring_mvc_notes.html.vue"]]);export{u as default};
