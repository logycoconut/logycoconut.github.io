import{_ as e}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as n,c as i,e as s}from"./app.01cb2567.js";const d={},l=s(`<blockquote><p>源自IT黑马的一份Oracle笔记，还挺详细的，很适合Oracle的入门</p></blockquote><h2 id="基本操作" tabindex="-1"><a class="header-anchor" href="#基本操作" aria-hidden="true">#</a> 基本操作</h2><h3 id="表空间、用户、表" tabindex="-1"><a class="header-anchor" href="#表空间、用户、表" aria-hidden="true">#</a> <strong>表空间、用户、表</strong></h3><ul><li><strong>创建表空间</strong></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>create tablespace oraclets
