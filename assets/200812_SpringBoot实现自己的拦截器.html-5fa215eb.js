import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,e as r}from"./app-28676176.js";const d={},l=r(`<blockquote><p>在 Web 开发中，我们经常需要对请求拦截并做一些动作，比如日志记录、权限检测或者性能检测等</p></blockquote><h2 id="handlerinterceptor" tabindex="-1"><a class="header-anchor" href="#handlerinterceptor" aria-hidden="true">#</a> HandlerInterceptor</h2><p>SpringMVC中提供了<code>HandlerInterceptor</code>接口, 我们来大致看一下它的源码 ( <strong>省略参数和异常以方便阅读</strong> )</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public interface HandlerInterceptor {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="权限检测场景" tabindex="-1"><a class="header-anchor" href="#权限检测场景" aria-hidden="true">#</a> 权限检测场景</h2><p>项目中有些接口需要对请求方进行登录检测, 检测通过之后才能访问<br> 所以我们可能需要写一个登录的拦截器, 在请求处理之前进行检测</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 伪代码，主要是为了演示
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14),a=[l];function s(t,c){return n(),i("div",null,a)}const u=e(d,[["render",s],["__file","200812_SpringBoot实现自己的拦截器.html.vue"]]);export{u as default};
