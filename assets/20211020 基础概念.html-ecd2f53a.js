import{_ as e,Y as i,Z as l,$ as s,a0 as a,a1 as t,a2 as p,I as c}from"./framework-beff9ad1.js";const o={},u=p(`<h2 id="名词解释" tabindex="-1"><a class="header-anchor" href="#名词解释" aria-hidden="true">#</a> 名词解释</h2><ul><li><p>集群与节点</p><p>集群是一个或多个 Node 的集合，每一个 Node 在启动时都会彼此发现，组成集群 （节点默认会加入一个叫 <code>elasticsearch</code> 的节点）</p></li><li><p>index 和 type</p><p>index 是一类拥有相似属性的 document 的集合，必须是小写的字符 type 作为 index 中的逻辑类别</p><p>（在 ES6 之后的版本逐步放弃type的概念，因为在 ES 中，一个Index下不同的type如果有相同的字段，他们会被luecence当作一个字段，并且他们的定义必须相同，这其实就是一个 Type 了呀）</p></li><li><p>document</p><p>index 里面的单条的记录，类似于关系型数据库中的行的概念</p></li><li><p>shards 分片</p><p>如果一个 index 存放了过多的数据，响应的速度就会下降</p><p><strong>所以 ES 可以将 index 分片，每一片都是一个 shards，分布在不同的节点中</strong></p><p>多个主分片加起来才是完整的数据，相当于一桶水用多个杯子装</p><p>分片分为主分片和副本分片，主分片数量在索引创建时指定，后续不允许修改，除非 Reindex，多个主分片加起来才是完整的数据</p></li><li><p>replicas 复制，也可以叫做备份分片</p><p>主分片和备分片不会出现在同一个节点上（防止单点故障）</p><p>默认情况下一个索引创建 5 个分片一个备份（即 5 primary+5 replica = 10 个分片）</p><p>replicas 不仅提供备份容灾的作用，也可以提高查询性能</p></li></ul><h2 id="基本用法" tabindex="-1"><a class="header-anchor" href="#基本用法" aria-hidden="true">#</a> 基本用法</h2><h3 id="创建索引" tabindex="-1"><a class="header-anchor" href="#创建索引" aria-hidden="true">#</a> 创建索引</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建一个叫做twitter的索引（index），并插入一个文档（document)</span>
PUT twitter/_doc/1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ul><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h2>`,10),r={href:"https://mp.weixin.qq.com/s/-j4DkNQI3Yj6FsuQsexNQg",target:"_blank",rel:"noopener noreferrer"},d={href:"https://juejin.cn/post/6844904030037245959#heading-0",target:"_blank",rel:"noopener noreferrer"},v=s("p",null,"​​",-1);function k(m,b){const n=c("ExternalLinkIcon");return i(),l("div",null,[u,s("ul",null,[s("li",null,[s("a",r,[a("Elasticsearch入门基础"),t(n)])]),s("li",null,[s("a",d,[a("利用Elasticsearch搜索数据"),t(n)])])]),v])}const g=e(o,[["render",k],["__file","20211020 基础概念.html.vue"]]);export{g as default};
