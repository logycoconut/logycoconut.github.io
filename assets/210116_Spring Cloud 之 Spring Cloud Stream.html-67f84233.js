    ...
    stream:
      bindings:
        ...
        log_output:
          destination: stream.log_message
          binder: remote_rabbit
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>配置完成，重启项目试试看吧</p><h3 id="其他" tabindex="-1"><a class="header-anchor" href="#其他" aria-hidden="true">#</a> 其他</h3><p>Spring Cloud Stream 中还有消费分区、消息降级等概念，篇幅有限，就不做展开啦(<em><sup>▽</sup></em>)</p><h2 id="相关源码地址" tabindex="-1"><a class="header-anchor" href="#相关源码地址" aria-hidden="true">#</a> 相关源码地址</h2><p>仅供参考</p>`,73),c={href:"https://github.com/logycoconut/Spring-Cloud-Notes/tree/master/stream",target:"_blank",rel:"noopener noreferrer"};function m(o,b){const i=t("ExternalLinkIcon");return s(),l("div",null,[v,e("p",null,[e("a",c,[a("https://github.com/logycoconut/Spring-Cloud-Notes/tree/master/stream"),d(i)])])])}const g=n(u,[["render",m],["__file","210116_Spring Cloud 之 Spring Cloud Stream.html.vue"]]);export{g as default};
