...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="相关源码地址" tabindex="-1"><a class="header-anchor" href="#相关源码地址" aria-hidden="true">#</a> 相关源码地址</h2><p>仅供参考</p>`,25),h={href:"https://github.com/logycoconut/Spring-Cloud-Notes/tree/master/eureka",target:"_blank",rel:"noopener noreferrer"};function y(f,_){const s=c("ExternalLinkIcon");return l(),p("div",null,[o,n("ol",u,[n("li",null,[a("运行 Application.java 文件，并访问 "),n("a",d,[a("http://localhost:10010"),e(s)]),a(" （没有任何后缀）")])]),v,n("ol",k,[n("li",null,[n("p",null,[a("运行 Application.java 文件，并查看 "),n("a",m,[a("http://localhost:10010"),e(s)]),a(" 是否有提供商的注册信息")])]),g]),b,n("p",null,[n("a",h,[a("https://github.com/logycoconut/Spring-Cloud-Notes/tree/master/eureka"),e(s)])])])}const S=t(r,[["render",y],["__file","023_spring_cloud_notes_eureka.html.vue"]]);export{S as default};
