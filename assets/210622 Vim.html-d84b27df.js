import{_ as n,Y as d,Z as a,$ as e,a0 as s,a1 as l,a2 as r,I as v}from"./framework-beff9ad1.js";const c={},u=r(`<h3 id="基本模式" tabindex="-1"><a class="header-anchor" href="#基本模式" aria-hidden="true">#</a> 基本模式</h3><ul><li>Normal：用于光标移动、搜索替换、复制粘贴删除</li><li>Visual：用于选中、反选（v: 按字符选中 V：按行选中）</li><li>Command： 用于文档操作，例如读取、保存</li><li>Insert：用于编辑内容</li></ul><h3 id="光标移动" tabindex="-1"><a class="header-anchor" href="#光标移动" aria-hidden="true">#</a> 光标移动</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>^: 移到行首
$: 移到行尾
...
等等...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h3>`,15),t={href:"https://www.yuque.com/manongkevinliang/ldtp9u/sg3fl4",target:"_blank",rel:"noopener noreferrer"},m=e("p",null,"​​",-1);function b(o,h){const i=v("ExternalLinkIcon");return d(),a("div",null,[u,e("p",null,[e("a",t,[s("Vim常用命令速查表（入门版）"),l(i)])]),m])}const g=n(c,[["render",b],["__file","210622 Vim.html.vue"]]);export{g as default};
