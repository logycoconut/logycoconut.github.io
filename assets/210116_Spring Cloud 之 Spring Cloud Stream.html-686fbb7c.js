import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{r as s,o as l,c as a,a as e,b as d,d as r,f as t}from"./app-d4eb8940.js";const u={},v=t(`<blockquote><p>Spring Cloud Stream 是 Spring Cloud 体系中的消息中间件组件，它集成了 kafka 和 rabbitMQ</p><p>它屏蔽掉了底层不同消息中间件之间的差异，降低了学习成本和维护成本 (就像我们用 ORM 框架来取代直接操作数据库一样)</p></blockquote><h2 id="快速上手" tabindex="-1"><a class="header-anchor" href="#快速上手" aria-hidden="true">#</a> 快速上手</h2><p>编写代码之前我们需要搭建一个 rabbitMQ 环境，这里不再累述</p><h3 id="构建消息生产者-stream-producer" tabindex="-1"><a class="header-anchor" href="#构建消息生产者-stream-producer" aria-hidden="true">#</a> 构建消息生产者 stream-producer</h3><ol><li>引入依赖</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
