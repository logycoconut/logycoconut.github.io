import{_ as l}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as d,c as s,a as e,d as a,b as c,e as n,r}from"./app.cf73cc21.js";const v={},o=n(`<blockquote><p>Spring的定时任务默认是单线程串行执行的, 那假设第一个任务比较耗时长, 直到超过任务二的设定时间之后才完成, 那么就会造成任务二不能及时完成, 进而造成其他问题</p></blockquote><h2 id="先来说说定时任务" tabindex="-1"><a class="header-anchor" href="#先来说说定时任务" aria-hidden="true">#</a> 先来说说定时任务</h2><p>开启对定时任务的支持, 在启动类上加上<code>@EnableScheduling</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 启动类
@EnableScheduling
